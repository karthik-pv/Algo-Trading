...
class KiteAdapter(BrokerInterface):
    ...
    def start_socket_connection(self, shutdown_event, trader_instance):
        ...
        def on_ticks(ws, ticks):
            trader_instance.set_latest_price(ticks)
        ...
        def on_order_update(ws, data):
            ...
            trader_instance.refresh_open_positions_and_buy_price()
            subscribe_instruments = trader_instance.get_relevant_instruments_to_track()
